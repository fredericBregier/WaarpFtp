...
public class FtpInternalConfiguration {
    ...
    /**
     * Try to unbind (closing the parent channel) the Passive Channel listening to the specified local address if the
     * last one. It returns only when the underlying parent channel is closed if this was the last session that wants to

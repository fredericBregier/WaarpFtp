...
public abstract class FtpConfiguration {
    ...
    /**
     * Default number of threads in pool for Server. The default value is for client for Executor in the Pipeline for
     * Business logic. Server will change this value on startup if not set. Default 0 means in proportion of real core
     * number.
     */
    ...
    /**
     * Reset the global monitor for bandwidth limitation and change future channel monitors with values divided by 10
     * (channel = global / 10)
     *
     * @param writeLimit
     * @param readLimit
     ...
     * the value is less than 64 threads.
     */

...
public class FtpTransferControl {
  ...
  /**
   * Blocking step for the Executor in order to wait for the end of the command
  ...
  /**
   * Add a new transfer to be executed. This is to be called from Command after
   * connection is opened and before
   * answering to the client that command is ready to be executed (for Store or
   ...
   * Add a new transfer to be executed. This is to be called from Command after
   * connection is opened and before
   * answering to the client that command is ready to be executed (for List like
   * operations).
   *
   * @param command
   * @param list
  ...
  /**
   * Is a command currently executing (called from {@link NetworkHandler} when a
   * message is received to see if another
  ...
  /**
   * Clear the FtpTransferControl (called when the data connection must be over
   * like from clear of {@link
   * FtpDataAsyncConn}, abort from {@link ABOR} or ending control connection
   * from {@link NetworkHandler}.
   */
  public void clear() {

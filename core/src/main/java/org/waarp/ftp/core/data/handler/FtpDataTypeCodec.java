...
/**
 * Second CODEC :<br> - encode/decode : takes a {@link DataBlock} and transforms
 * it to a new {@link DataBlock} according
 * to the types<br> Force ASCII, EBCDIC or IMAGE (with NON PRINT). LOCAL and
 * other subtypes are not implemented.
 *

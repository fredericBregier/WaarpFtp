...
public class NetworkHandler extends SimpleChannelInboundHandler<String> {
    ...
    /**
     * Default exception task: close the current connection after calling exceptionLocalCaught and writing if possible
     * the current replyCode.
     */
    @Override
                                                  ...
                                                  new GenericFutureListener<Future<? super Channel>>() {
                                                      public void operationComplete(Future<? super Channel> future)
                                                          ...
                                                          if (!future.isSuccess()) {
                                                              ...
                                                              logger.error(
                                                                      "Cannot finalize Ssl Command channel " + error2);

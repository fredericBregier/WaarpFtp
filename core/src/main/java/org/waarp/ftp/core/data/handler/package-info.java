 ...
 * It first tries to find the corresponding session setup from the control connection. Then it setups the FTP codec.
 * Finally it informs the FtpTransferControl object that the data connection is opened and ready, such that the transfer
 * can start correctly.
 ...
 * FtpTransferControl) and wake up the process of writing from channelInterestChanged in order to prevent OOME.

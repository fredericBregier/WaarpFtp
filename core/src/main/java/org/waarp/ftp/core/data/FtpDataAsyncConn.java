...
public class FtpDataAsyncConn {
    ...
    /**
     * Active: the connection is done from the Server to the Client on this remotePort Passive: not used
     */
    private volatile int remotePort = -1;
    /**
     * Active: the connection is done from the Server from this localPort to the Client Passive: the connection is done
     * from the Client to the Server on this localPort
     */
    ...
    /**
     * @return True if the connection is bind (active = connected, passive = not necessarily connected)
     */
    ...
    /**
     * @return True if the current mode for data connection is FileInterface + (Stream or Block) + (Ascii or Image)
     */

 ...
 * network based on the {@link InetAddress}
 * of the remote client and the {@link InetSocketAddress} of the server for
 * Passive and reverse for Active connections.
 * This is particularly useful for Passive mode connection since there is no way
 * to pass the session to the connected

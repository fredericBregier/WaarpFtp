...
/**
 * Third CODEC :<br> - encode/decode : takes {@link DataBlock} and transforms it to a {@link DataBlock}<br> FILE and
 * RECORD are implemented (DataNetworkHandler will do the real job). PAGE is not implemented.<br> Note that real actions
 * are taken in the DataNetworkHandler according to the implementation of FtpFile.
 *
